...
<head>
    ...
    <style>
        ...
        *,
        ...
        <blade media|%20(prefers-reduced-motion%3A%20no-preference)%20%7B>.motion-safe\:hover\:scale-\[1\.01\]:hover {
            --tw-scale-x: 1.01;
            --tw-scale-y: 1.01;
            transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))
        }
        ...
        <blade media|%20(prefers-color-scheme%3A%20dark)%20%7B>.dark\:bg-gray-900 {
            --tw-bg-opacity: 1;
        ...
        <blade media|%20(min-width%3A%20640px)%20%7B>.sm\:fixed {
            position: fixed
        }
        ...
        <blade media|%20(min-width%3A%20768px)%20%7B>.md\:grid-cols-2 {
            grid-template-columns: repeat(2, minmax(0, 1fr))
        }
        }

        <blade media|%20(min-width%3A%201024px)%20%7B>.lg\:gap-8 {
            gap: 2rem
        }
