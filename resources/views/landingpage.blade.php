...
<head>
    <meta charset="utf-8">
    <title>Dronezone - Drone Renting in Surabaya</title>
            ...
            <div class="row gx-0">
                <div class="col-lg-3 bg-dark d-none d-lg-block">
                    <a href="index.html"
                        ...
                        <h1 class="m-0 text-primary text-uppercase">Dronezone</h1>
                    </a>
                </div>
                <div class="col-lg-9">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            ...
                            <a href="https://htmlcodex.com/hotel-html-template-pro"
                                class="btn btn-primary rounded-0 py-4 px-md-5 d-none d-lg-block">Login</a>
                        </div>
                    </nav>
                </div>
            </div>
